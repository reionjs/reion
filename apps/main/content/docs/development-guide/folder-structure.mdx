...
description: Folder structure, file naming conventions, and how Reion maps files to routes, middleware, and events.
---

# Folder Structure

This guide explains how Reion organizes your `appDir` directory: which folders and file names are special, how URL paths are derived, and how to name files for routes, middleware, and events.
